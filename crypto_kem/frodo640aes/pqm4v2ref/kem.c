...
int PQCLEAN_FRODOKEM640AES_CLEAN_crypto_kem_keypair(unsigned char *pk, unsigned char *sk) {
    ...
    // Cleanup:
    PQCLEAN_FRODOKEM640AES_CLEAN_clear_bytes((unsigned char *)S, PARAMS_N * PARAMS_NBAR * sizeof(uint16_t));
    PQCLEAN_FRODOKEM640AES_CLEAN_clear_bytes((unsigned char *)E, PARAMS_N * PARAMS_NBAR * sizeof(uint16_t));
...
int PQCLEAN_FRODOKEM640AES_CLEAN_crypto_kem_enc(unsigned char *ct, unsigned char *ss, const unsigned char *pk) {
    ...
    // Cleanup:
    PQCLEAN_FRODOKEM640AES_CLEAN_clear_bytes((unsigned char *)V, PARAMS_NBAR * PARAMS_NBAR * sizeof(uint16_t));
    PQCLEAN_FRODOKEM640AES_CLEAN_clear_bytes((unsigned char *)Sp, PARAMS_N * PARAMS_NBAR * sizeof(uint16_t));
    PQCLEAN_FRODOKEM640AES_CLEAN_clear_bytes((unsigned char *)Ep, PARAMS_N * PARAMS_NBAR * sizeof(uint16_t));
    PQCLEAN_FRODOKEM640AES_CLEAN_clear_bytes((unsigned char *)Epp, PARAMS_NBAR * PARAMS_NBAR * sizeof(uint16_t));
...
int PQCLEAN_FRODOKEM640AES_CLEAN_crypto_kem_dec(unsigned char *ss, const unsigned char *ct, const unsigned char *sk) {
    ...
    // Cleanup:
    PQCLEAN_FRODOKEM640AES_CLEAN_clear_bytes((unsigned char *)W, PARAMS_NBAR * PARAMS_NBAR * sizeof(uint16_t));
    PQCLEAN_FRODOKEM640AES_CLEAN_clear_bytes((unsigned char *)Sp, PARAMS_N * PARAMS_NBAR * sizeof(uint16_t));
    PQCLEAN_FRODOKEM640AES_CLEAN_clear_bytes((unsigned char *)S, PARAMS_N * PARAMS_NBAR * sizeof(uint16_t));
    PQCLEAN_FRODOKEM640AES_CLEAN_clear_bytes((unsigned char *)Ep, PARAMS_N * PARAMS_NBAR * sizeof(uint16_t));
    PQCLEAN_FRODOKEM640AES_CLEAN_clear_bytes((unsigned char *)Epp, PARAMS_NBAR * PARAMS_NBAR * sizeof(uint16_t));
