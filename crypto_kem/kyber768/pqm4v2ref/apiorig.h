...
#define PQCLEAN_KYBER768_CLEAN_crypto_kem_keypair crypto_kem_keypair
#define PQCLEAN_KYBER768_CLEAN_crypto_kem_enc crypto_kem_enc
#define PQCLEAN_KYBER768_CLEAN_crypto_kem_dec crypto_kem_dec
