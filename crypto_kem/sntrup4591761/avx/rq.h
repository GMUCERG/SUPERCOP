...
#define rq_roundencode crypto_kem_sntrup4591761_ref_rq_roundencode
...
#define rq_round3 crypto_kem_sntrup4591761_ref_rq_round3
extern void rq_round3(modq *,const modq *);

#define rq_mod3 crypto_kem_sntrup4591761_ref_rq_mod3
